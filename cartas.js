/*
  BARALHO OFICIAL - Cards Against Humanity (versao 2.4)
  ----------------------------------------------------
  Transcrito do PDF oficial de impressao caseira.

  Cards Against Humanity e distribuido sob a licenca
  Creative Commons BY-NC-SA 2.0.
  https://creativecommons.org/licenses/by-nc-sa/2.0/

  Isso quer dizer: pode usar e modificar de graca, tem que dar credito,
  e NAO pode vender nem ganhar dinheiro com isso.
...
const PRETAS = [
  ...
  "Mitch McConnell can't cum without ___.",
  ...
  "In Jordan Peele's new thriller, a young family discovers that ___ had really been ___ all along.",
  ...
  "___. It's a trap!",
  "Hulu's new reality show features twelve hot singles living with ___.",
  ...
  "Well if you'll excuse me, gentlemen, I have a date with ___.",
  "Alternative medicine is now embracing the curative powers of ___.",
  "As the mom of five rambunctious boys, I'm no stranger to ___.",
  "___. High five, bro.",
  "Today on Maury: \"Help! My son is ___!\"",
  "I get by with a little help from ___.",
  "Do NOT go here! Found ___ in my fettuccine alfredo!",
  "I drink to forget ___.",
  "I'm LeBron James, and when I'm not slamming dunks, I love ___.",
  "What makes life worth living?",
  "Arby's: We Have ___.",
  "Mr. and Mrs. Diaz, we called you in because we're concerned about Cynthia. Are you aware that your daughter is ___?",
  "If you can't be with the one you love, love ___.",
  "Brought to you by Bud Light, the Official Beer of ___.",
  "Click Here for ___!!!",
  "Check me out, yo! I call this dance move \"___.\"",
  "Old MacDonald had ___. E-I-E-I-O.",
  "Men's Wearhouse: You're gonna like ___. I guarantee it."
];
